  ...
  return (
    <div className="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      <blockquote className="text-center lg:mx-auto lg:w-3/5">
        <Meta className="mx-auto w-20 h-auto sm:w-28 dark:invert mb-10" />
        <div className="">
          <p className="relative text-xl sm:text-2xl md:text-3xl md:leading-normal font-medium ">
            ...
            <span className="relative z-10 ">
              Wow RemindEvent is the best platform i have ever used. Definitely
              Recommend it to you guys, try it out!
            </span>
          </p>
        </div>
        <footer className="mt-6">
          <div className="font-semibold ">John Thor</div>
